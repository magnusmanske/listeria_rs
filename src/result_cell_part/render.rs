//! Rendering helpers for [`ResultCellPart`] — wikitext and tabbed-data output.
...
use super::{EntityInfo, ExternalIdInfo, LinkTarget, LocalLinkInfo, LocationInfo, PartWithReference, ResultCellPart};
...
impl ResultCellPart {
    ...
    async fn localize_snak_list(
        ...
        for part_with_reference in v.iter_mut() {
            let result_cell_part = part_with_reference.part_mut();
